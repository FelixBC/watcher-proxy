...
- `poll-hub.js` — el reporte cada ~2 min: manda estado (internet, proxy, filtro, bloqueos, visitas), registra transiciones de internet, y recibe instrucciones (whitelist, unplug, nombre/zona, versión, diagnóstico).
